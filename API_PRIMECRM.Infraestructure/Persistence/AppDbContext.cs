...
using API_PRIMECRM.Domain.Models.Liquidaciones;
...
namespace PrimeCRM_Api.Infraestructure.Persistence
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            RestockConfigure(modelBuilder);
            ConfigureSale(modelBuilder);
            ConfigureLiquidation(modelBuilder);
        ...
        private void ConfigureLiquidation(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<LiquidationItem>(e =>
            {
                ...
                e.HasOne(l => l.Sale)
                    ...
                    .HasForeignKey<LiquidationItem>(li => li.SaleId)
                    .OnDelete(DeleteBehavior.Restrict);
